...
I denne delen viser vi hvordan man kan bruke QField til å kartlegge i prosjekter som er opprettet med programtillegget *"Natur i Norge"-kartlegging*. Det er også mulig å bruke QGIS for feltkartlegging. Dersoim du trenger veiledningsmateriale for kartlegging i QGIS kan du bruke følgende linker:
...
### Åpne prosjekt via QField Cloud

### Klikk på QField Cloud Projects
...
![](images/open_project_qfield_3.png)
...
### Høyreklikk på kartlaget du ønsker å zoome til
...
### Zoom ved å bruke scrollefunksjonen med musa. Du zoomer inn ved å scrolle i retningen vekk fra deg og ut ved å scrolle i retningen inn mot deg

## Naviger

### Klikk mens du drar musa i motsatt retning av den retningen du ønsker å flytte kartvinduet
...
#### Høyreklikk på kartlaget (f.eks. nin_polygons som brukes til kartlegging)
...
### Utfigurér ny polygon

#### Klikk i kartvinduet for å lage et hjørnepunkt for polygonen. Merk at du må unngå å flytte musepekeren samtidig som du klikker for å lage et hjørnepunkt.
...
#### Utfigurér polygonen ved å lage alle ønskede hjørnepunkter. Pass på å unngå topologifeil. Vanlige topologifeil er:
...
![](images/mapping_guidelines3.png)
...
Merk at tilsvarende informasjon gis av NiN-feltveilederen.

![](images/mapping_guidelines2.png)

#### Klikk i feltet for å skrive hvor mye av polygonen som dekkes av den valgte naturtypen.
...
### Utfigurér og registrer nye polygoner
...
![](images/neighbour_polygon2.png)

### Rediger utfigurering til eksisterende polygoner

#### Redigere hjørnekoordinater

##### Hold inne venstre museknapp for å markere en polygon du vil redigere
...
##### Flytt musepekeren dit du vil flytte hjørnekoordinaten

![](images/edit_polygon6.png)

##### Klikk igjen når du har flyttet musepekeren til den ønskede posisjonen
...
##### Flytt musepekeren dit du vil at hjørnekoordinaten skal opprettes

![](images/edit_polygon9.png)

##### Klikk igjen når du har flyttet musepekeren dit du vil at hjørnekoordinaten skal opprettes

![](images/edit_polygon10.png)

##### Klikk på (\<-) for å angre forrige oppretting eller endring av hjørnekoordinat. Klikk på (X) for trekke tilbake alle endringene.
...
### Rediger attributter for eksisterende polygoner
...
##### Hold inne venstre museknapp for å markere en polygon du vil slette
...
##### Hold inne venstre museknapp mens du holder musepekeren over grensen mellom polygonene du vil sammensmelte
...
##### Klikk på symbolet for frihpndstegning for å slå funksjonen på (at det lyser grønt betyr at funksjonen er slått på)

![](images/free_draw2.png)

##### Utfigurer polygoner ved å trykke på og holde inne venstre museknapp og deretter dra musepekeren over kartvinduet. Slipp museknappen når polygonen er ferdig utfigurert.
...
##### Utfigurer polygoner som vanlig. Musepekeren vil automatisk snappes til nærmest 45 graders vinkel i forhold til forrige hjørnekoordinat og det vil dukke opp en stiplet linje som viser dette.
...
#### Høyreklikk på kartlaget du vil endre gjennomsiktigheten til

![](images/visibility2.png)

#### Klikk på skyve... og dra den til siden for å endre på gjennomsiktigheten til kartlaget
...
## Synkronisere med QField Cloud 

### Klikk på menyknappen

![](images/push.png)

### Klikk på ikonet for QField Cloud
...
A. Klikk på Synchronize for å både laste opp endringer til og laste ned endringer fra QField Cloud 
B. Klikk på Push changes for å både laste opp endringer til QField Cloud 
C. Klikk på Revert changes for å avbryte endringene som er gjort
