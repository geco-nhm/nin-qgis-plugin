...
Sørg for at redigeringsmodus er på (se kapittel \@ref(redigeringsmodus)) og at du redigerer i riktig kartlag.
...
C. Klikk på `Revert local changes` for å avbryte endringene som er gjort
