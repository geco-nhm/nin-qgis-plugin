...
A. Klikk på `Synchronize` for å både laste opp endringer til og laste ned endringer fra QFieldCloud  B. Klikk på `Push changes` for å både laste opp endringer til QFieldCloud  C. Klikk på `Revert local changes` for å avbryte endringene som er gjort

::: {style="display: flex; justify-content: space-between; margin-top: 3em;"}
<div>

← <a href="eksportere-prosjekt.html">Gå til forrige kapittel</a>

</div>

<div>

<a href="kvalitetssikring.html">Gå til neste kapittel</a> →
