...
I denne delen viser vi hvordan man kan bruke QField til å kartlegge i prosjekter som er opprettet med programtillegget *"Natur i Norge"-kartlegging*. Det er også mulig å bruke QGIS for feltkartlegging. Dersom du trenger veiledningsmateriale for kartlegging i QGIS kan du bruke følgende linker:
...
#### Utfigurér polygonen ved å lage alle ønskede hjørnepunkter. Pass på å unngå topologifeil (se kapittel 6 Kvalitetssikring)
...
![](images/snapping4.png) 

Dersom du nå prøver å holde musepekeren over en polygongrense vil du legge merke til at musepekeren ikke lenger snappes automatisk til polygonen.
...
![](images/visibility4.png) 

![](images/visibility5.png)

Gjennomsiktigheten på kartlaget vil nå være endret.

### Registrere punkter

Sørg for at redigeringsmodus er på (se kapittel 2.6.2 Slå på redigeringsmodus) og at du redigerer i riktig kartlag.
