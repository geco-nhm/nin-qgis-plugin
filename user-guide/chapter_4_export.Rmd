# Eksportere prosjekt {#eksportere-prosjekt}
...
På samme måte er det mulig å importere prosjektet i QGIS. Først må du sørge for at enhetene er koblet sammen via kabelen.
...
Før du kan importere prosjektet i QGIS må du sørge for at endringene som er gjort i QField er lastet opp til QFieldCloud (se \@ref(import-qfieldcloud) [Legg inn prosjekt i QFieldCloud](#import-qfieldcloud)). Importering av prosjektet i QGIS er kun mulig med internett-tilgang.
