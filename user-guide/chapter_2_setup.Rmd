...
##### 1.3.2.3 Navigér til mappen hvor rasterlaget er lagret
...
Prosjektet kan eksporteres fra QGIS på en enhet til QField på en annen enhet på to måter.

#### 1.4.1 Eksporter prosjekt ved hjelp av minnepenn (USB)

##### 1.4.1.1 Åpne File Explorer

Skjermbilde

##### 1.4.1.2 Naviger til mappen der du lagret mappen med prosjektet

Skjermbilde

##### 1.4.1.3 Klikk på mappen mens du holder inne og drar den over til mappen for minnepennen
