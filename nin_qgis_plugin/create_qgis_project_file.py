'''Creates a QGIS project file for the NiN mapping plugin'''
# -*- coding: utf-8 -*-
...
from qgis.core import (
    ...
    QgsCoordinateReferenceSystem, QgsDataProvider,
    QgsVectorLayer, QgsMapLayer, QgsRelation,
    QgsSymbolLayerReference, QgsSnappingConfig,
    QgsTolerance
)
